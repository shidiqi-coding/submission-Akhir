...
.note-list{
    ...
    <div class="form-contain">
      ...
      <div id ="popupConfirmation" class ="confirmation-popup">
       ...
       this._popupConfirmation = this._shadowRoot.querySelector("#popupConfirmation");
       this._confirmButton = this._shadowRoot.querySelector("#confirmButton");

  }
  connectedCallback(){
    this._formElements.addEventListener("submit", this._onSubmit.bind(this));
    this._confirmButton.addEventListener("click", this.closeConfirmation.bind(this),);
  }
