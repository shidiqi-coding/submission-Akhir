...
const noteLoadingElement =
  noteContainListElemenst.querySelector(".search-loading");
const noteListElements = noteListContainElements.querySelector("note-list");
...
// const home = async () => {
//   const addNotes = document.querySelector("input-form"),
//        formContain = document.querySelector("form-contain"),
//         notesTitle = formContain.querySelector("input"),
//         notesDesc = formContain.querySelector("textarea"),
//         addButton = formContain.querySelector("btn");
